...
var aws_s3_utils_1 = require("../../shared/aws.s3.utils");
var s3Uploader = new aws_s3_utils_1.AWSS3Uploader({
...
var resolver = {
    Mutation: {
        editProfile: users_utils_1.protectedResolver(function (_, _a, _b) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                var user, avatarUrl, uglyPassword, updatedUser;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            ...
                            avatarUrl = _c.sent();
                            return [4 /*yield*/, shared_utils_1.deleteFromS3(user.avatar)];
                        case 3:
                            _c.sent();
                            _c.label = 4;
                        case 4:
